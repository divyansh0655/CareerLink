    ...
    <div className="text-center">
            ...
            <Accordion data-bs-theme="dark">
                  <Accordion.Item eventKey="0">
                    <Accordion.Header><span className="badge rounded-circle" style={{backgroundColor:"rgba(1,1,12)"}}>1</span> &nbsp;&nbsp;What is Careerlink?</Accordion.Header>
                    <Accordion.Body>
                  ...
                  <Accordion.Item eventKey="1">
                    <Accordion.Header><span className="badge rounded-circle" style={{backgroundColor:"rgba(1,1,12)"}}>2</span> &nbsp;&nbsp;Why go for Careerlink?</Accordion.Header>
                    <Accordion.Body>
                  ...
                  <Accordion.Item eventKey="2">
                    <Accordion.Header><span className="badge rounded-circle" style={{backgroundColor:"rgba(1,1,12)"}}>3</span> &nbsp;&nbsp;What makes CareerLink unique?</Accordion.Header>
                    <Accordion.Body>
                  ...
                  <Accordion.Item eventKey="3">
                    <Accordion.Header><span className="badge rounded-circle" style={{backgroundColor:"rgba(1,1,12)"}}>4</span> &nbsp;&nbsp;Who can use CareerLink?</Accordion.Header>
                    <Accordion.Body>
                  ...
                  <Accordion.Item eventKey="4">
                    <Accordion.Header><span className="badge rounded-circle" style={{backgroundColor:"rgba(1,1,12)"}}>5</span> &nbsp;&nbsp;Why did we choose the name “CareerLink”?</Accordion.Header>
                    <Accordion.Body>
